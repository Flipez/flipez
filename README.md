...
- [mozilla/terraform-modules](https://github.com/mozilla/terraform-modules) ([v1.66.0](https://github.com/mozilla/terraform-modules/releases/tag/v1.66.0), 2 days ago) - Cross-SRE Terraform modules
- [mozilla-it/refractr](https://github.com/mozilla-it/refractr) ([v0.0.182](https://github.com/mozilla-it/refractr/releases/tag/v0.0.182), 6 days ago) - yaml -&gt; nginx for redirects and rewrites
...
- [feat(search.services): add 503 for search.services.mozilla.com](https://github.com/mozilla-it/refractr/pull/326) on [mozilla-it/refractr](https://github.com/mozilla-it/refractr) (4 weeks ago)
