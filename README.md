...
- [Flipez/bkv](https://github.com/Flipez/bkv) -  (3 weeks ago)
...
- [mozilla-it/refractr](https://github.com/mozilla-it/refractr) ([v0.0.155](https://github.com/mozilla-it/refractr/releases/tag/v0.0.155), 1 day ago) - yaml -&gt; nginx for redirects and rewrites
- [mozilla/terraform-modules](https://github.com/mozilla/terraform-modules) ([v1.40.0](https://github.com/mozilla/terraform-modules/releases/tag/v1.40.0), 3 days ago) - Cross-SRE Terraform modules
- [common-voice/common-voice](https://github.com/common-voice/common-voice) ([release-v1.106.1](https://github.com/common-voice/common-voice/releases/tag/release-v1.106.1), 3 days ago) - Common Voice is part of Mozilla&#39;s initiative to help teach machines how real people speak.
- [Flipez/hcloud-kv](https://github.com/Flipez/hcloud-kv) ([v1.1.0](https://github.com/Flipez/hcloud-kv/releases/tag/v1.1.0), 4 weeks ago) - Simple, free key/value store based on hetzner-cloud. plz don&#39;t sue me
...
- [github/scientist](https://github.com/github/scientist) - :microscope: A Ruby library for carefully refactoring critical paths. (2 days ago)
...
- [geophile/marcel](https://github.com/geophile/marcel) - A modern shell (3 weeks ago)
...
- [Baekalfen/PyBoy](https://github.com/Baekalfen/PyBoy) - Game Boy emulator written in Python (4 weeks ago)
- [PWhiddy/PokemonRedExperiments](https://github.com/PWhiddy/PokemonRedExperiments) - Playing Pokemon Red with Reinforcement Learning (4 weeks ago)
