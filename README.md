...
- [mozilla-it/refractr](https://github.com/mozilla-it/refractr) ([v0.0.183](https://github.com/mozilla-it/refractr/releases/tag/v0.0.183), today) - yaml -&gt; nginx for redirects and rewrites
- [mozilla/terraform-modules](https://github.com/mozilla/terraform-modules) ([v1.68.1](https://github.com/mozilla/terraform-modules/releases/tag/v1.68.1), 2 days ago) - Cross-SRE Terraform modules
