...
- [mozilla-it/deploy-actions](https://github.com/mozilla-it/deploy-actions) ([v3.11.3](https://github.com/mozilla-it/deploy-actions/releases/tag/v3.11.3), 6 days ago) - Generic GitHub composite actions/workflows for deploying applications
- [mozilla/terraform-modules](https://github.com/mozilla/terraform-modules) ([v1.72.0](https://github.com/mozilla/terraform-modules/releases/tag/v1.72.0), 6 days ago) - Cross-SRE Terraform modules
...
- [remove disableCache (deprecated) and replace deprecated wfGetCache](https://github.com/mozilla/mediawiki-bugzilla/pull/108) on [mozilla/mediawiki-bugzilla](https://github.com/mozilla/mediawiki-bugzilla) (5 days ago)
...
- [captbaritone/webamp](https://github.com/captbaritone/webamp) - Winamp 2 reimplemented for the browser (2 weeks ago)
- [kitao/pyxel](https://github.com/kitao/pyxel) - A retro game engine for Python (2 weeks ago)
