...
- [feat(deploy): add helm list after upgrade and output chart and app ve…](https://github.com/mozilla-it/deploy-actions/pull/29) on [mozilla-it/deploy-actions](https://github.com/mozilla-it/deploy-actions) (today)
