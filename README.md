...
- [mozilla/terraform-modules](https://github.com/mozilla/terraform-modules) ([v2.0.0](https://github.com/mozilla/terraform-modules/releases/tag/v2.0.0), 1 day ago) - Cross-SRE Terraform modules
...
- [mozilla-it/deploy-actions](https://github.com/mozilla-it/deploy-actions) ([v3.11.4](https://github.com/mozilla-it/deploy-actions/releases/tag/v3.11.4), 1 day ago) - Generic GitHub composite actions/workflows for deploying applications
