...
- [mozilla-it/refractr](https://github.com/mozilla-it/refractr) ([v0.0.193](https://github.com/mozilla-it/refractr/releases/tag/v0.0.193), 1 week ago) - yaml -&gt; nginx for redirects and rewrites
...
- [Flipez/hcloud-kv](https://github.com/Flipez/hcloud-kv) ([v1.1.0](https://github.com/Flipez/hcloud-kv/releases/tag/v1.1.0), 1 year ago) - Simple, free key/value store based on hetzner-cloud. plz don&#39;t sue me
...
- [use papermod](https://github.com/Flipez/blog.auch.cool/pull/61) on [Flipez/blog.auch.cool](https://github.com/Flipez/blog.auch.cool) (4 weeks ago)
...
- [feat(discourse): add sidekiq cleanup cronjob](https://github.com/mozilla-it/itse-apps-stage-1-infra/pull/133) on [mozilla-it/itse-apps-stage-1-infra](https://github.com/mozilla-it/itse-apps-stage-1-infra) (7 months ago)
...
- [Shopify/yjit](https://github.com/Shopify/yjit) - Optimizing JIT compiler built inside CRuby (1 week ago)
- [sambecker/exif-photo-blog](https://github.com/sambecker/exif-photo-blog) - Photo blog, reporting 🤓 EXIF camera details (aperture, shutter speed, ISO) for each image. (4 weeks ago)
